...
typedef struct
{
    ...
    short		width;
    short		height;
    int32_t		columndirectory;	// OBSOLETE (FIX: changed void** to int32 for 64-bit builds)
    short		patchcount;
...
void R_InitTextures (void)
{
    ...
    // FIX: memory corruption due to using 4 instead of sizeof
...
void R_InitColormaps (void)
{
    ...
    colormaps = (byte *)( ((size_t)colormaps + 255)&~0xff);
